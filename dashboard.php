...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div>
        <br><br><br>
        <center><h2> GABUDNUS </h2></center>
        <center><a  href="./index.php"><img src="./image/LogoGABUDNUS.png" width="250px" ></img></a>

        <br>
       <table width="50%">
      <tr><td>
      <p align="center">Memainkan game budaya INDONESIA sebagai pengetahuan bahwa kita anak-anak INDONESIA mempunyai pengetahuan tentang budaya kita sendiri. Ayo dapatkan aplikasinya secara gratis dengan menekan tombol di bawah ini.</p>    
      </td></tr>
      </table>
        </center>
    </div>
