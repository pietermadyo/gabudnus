      ...
      <div class="container-fluid">
        ...
        <!-- Icon Cards-->
          <div class="dart-headingstyle-one dart-mb-20">  <!--Style 1-->
            <h2 class="dart-heading">Tambah Admin</h2>
          </div>
<br/>
            <form class="form-horizontal" name ="form1" method="post" action = "simpanuser.php">

                <!-- Text input-->
                <div class="form-group">
                  <label class="col-md-4 control-label" for="textinput">Email</label>  
                  <div class="col-md-4">
                    <input id="email" name="email" type="email" placeholder="Masukan email" class="form-control input-md" required="">                    
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="password" name="password" type="text" placeholder="Masukan password" class="form-control input-md" required="">              
                  </div>
                </div>

                <button class="btn btn-primary " type="submit" name="save" >Simpan</button>
				<button class="btn btn-primary " type="reset" name="save" >Batal</button>
