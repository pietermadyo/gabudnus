      ...
      <div class="container-fluid">
        ...
        <!-- Icon Cards-->
          <div class="dart-headingstyle-one dart-mb-20">  <!--Style 1-->
            <h2 class="dart-heading">Input Pertanyaan</h2>
          </div>
<br/>
            <form class="form-horizontal" name ="form1" method="post" action = "simpansoal.php" enctype="multipart/form-data">

                <!-- Text input-->
                <div class="form-group">
                  <label class="col-md-4 control-label" for="textinput">Soal</label>  
                  <div class="col-md-4">
                    <input id="soal" name="soal" type="text" placeholder="Masukan soal" class="form-control input-md" required="">                    
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="gambar" name="gambar" type="file" class="form-control input-md" required="">
					<br/>
                    <img id="image_upload_preview" src="http://placehold.it/200x200" width='250px' height='250px'/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="jwb1" name="pilihan0" type="text" placeholder="Masukan Jawaban" class="form-control input-md">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="jwb2" name="pilihan1" type="text" placeholder="Masukan Jawaban" class="form-control input-md">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="jwb3" name="pilihan2" type="text" placeholder="Masukan Jawaban" class="form-control input-md">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="jwb4" name="pilihan3" type="text" placeholder="Masukan Jawaban" class="form-control input-md">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="jwb_bnr" name="jawab_benar" max="4" type="number" placeholder="Masukan Jawaban" class="form-control input-md">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="nilai" name="nilai" type="number" placeholder="Masukan nilai" class="form-control input-md">
                  </div>
                </div>
				
                <button class="btn btn-primary " type="submit" name="save" >Simpan</button>
				<button class="btn btn-primary " type="reset" name="reset" >Batal</button>
